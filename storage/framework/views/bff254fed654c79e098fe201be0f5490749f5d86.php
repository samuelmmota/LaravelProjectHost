...
<title>MR. Automotive | Sobre Nós </title>
...
<?php $__env->startSection('content'); ?>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title about-title">
                        <h2>Bem vindo ao Mr. Automotive <br />Fornecemos tudo o que precisa para o seu carro</h2>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="about__feature__item">
                            <img src="resources/theme/img/about/af-1.png" alt="">
                            <h5>Qualidade assegurada</h5>
                            <p>It seems though that some of the biggest problems with the internet advertising trends
                                are the lack of</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="about__feature__item">
                            <img src="resources/theme/img/about/af-2.png" alt="">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="about__feature__item">
                            <img src="resources/theme/img/about/af-3.png" alt="">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="about__pic">
                        <img src="resources/theme/img/about/about-pic.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="about__item">
                        <h5>A nossa missão</h5>
    ...
    <!-- Call Section Begin -->
    <section class="call spad set-bg" data-setbg="resources/theme/img/about/call-bg.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-md-6">
                    <div class="call__text">
                        <div class="section-title">
                            <h2>Peça informações</h2>
                ...
                <div class="col-lg-6 offset-lg-1 col-md-6">
                    <form action="#" class="call__form">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <select>
                                    <option value="">Escolha os nossos serviços</option>
                                    <option value="">Comprar carros</option>
                                    <option value="">Vender carros</option>
                                    <option value="">Alugar carros</option>
                                </select>
                            </div>
                        </div>
                        <button type="submit" class="site-btn">Submeter</button>
                    </form>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="team__item">
                        <div class="team__item__pic">
                            <img src="resources/theme/img/about/team-1.jpg" alt="">
                        </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="team__item">
                        <div class="team__item__pic">
                            <img src="resources/theme/img/about/team-2.jpg" alt="">
                        </div>
                        <div class="team__item__text">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="team__item">
                        <div class="team__item__pic">
                            <img src="resources/theme/img/about/team-3.jpg" alt="">
                        </div>
                        <div class="team__item__text">
                            <h5>Sean Robbins</h5>
                            <span>Manager</span>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="team__item">
                        <div class="team__item__pic">
                            <img src="resources/theme/img/about/team-4.jpg" alt="">
                        </div>
                        <div class="team__item__text">
                            <h5>Lucy Myers</h5>
                            <span>Delivary</span>
                ...
                <div class="testimonial__slider owl-carousel">
                        ...
                        <div class="testimonial__item">
                            <div class="testimonial__item__author">
                                <div class="testimonial__item__author__pic">
                                    <img src="resources/theme/img/testimonial/testimonial-1.png" alt="">
                                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="testimonial__item">
                            <div class="testimonial__item__author">
                                <div class="testimonial__item__author__pic">
                                    <img src="resources/theme/img/testimonial/testimonial-2.png" alt="">
                                </div>
                                <div class="testimonial__item__author__text">
                                    <div class="rating">
                                        <i class="fa fa-star"></i>
    ...
    <!-- Counter Begin -->
    <div class="counter spad set-bg" data-setbg="resources/theme/img/counter-bg.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="counter__item">
                        <h2 class="counter-num">1922</h2>
                        <p>Veículos em stock</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="counter__item">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <a href="#" class="client__item">
                        <img src="resources/theme/img/clients/client-1.png" alt="">
                    </a>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <a href="#" class="client__item">
                        <img src="resources/theme/img/clients/client-2.png" alt="">
                    </a>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <a href="#" class="client__item">
                        <img src="resources/theme/img/clients/client-3.png" alt="">
                    </a>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <a href="#" class="client__item">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <a href="#" class="client__item">
                        <img src="resources/theme/img/clients/client-4.png" alt="">
                    </a>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <a href="#" class="client__item">
                        <img src="resources/theme/img/clients/client-5.png" alt="">
                    </a>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <a href="#" class="client__item">
                        <img src="resources/theme/img/clients/client-6.png" alt="">
                    </a>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <a href="#" class="client__item">
                        <img src="resources/theme/img/clients/client-7.png" alt="">
                    </a>
                </div>
            </div>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/Code/public/resources/views/layouts/about.blade.php ENDPATH**/ ?>