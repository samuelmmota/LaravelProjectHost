  ...
  <div class="p-3 mb-2 bg-secondary text-white">
    ...
    <div class="container-fluid">
      <a class="btn btn-primary" href="<?php echo e(url('/product')); ?>" role="button">Criar Anuncio</a>
        <?php $__empty_1 = true; $__currentLoopData = App\Http\Controllers\AnunciosController::findAnunciosById(Auth::user()->id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $anuncio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
      <div class="row">
              ...
              <div class="card-body">
                ...
                <div class="container">
                  <div class="row">
                    ...
                    <div class="col-sm-2 text-dark">
                      <a href="/anuncios/delete?id=<?php echo e($anuncio->id_anuncio); ?>" style="color:black;">Arquivar</a>
                    </div>
                    <?php if($anuncio->destacado==0): ?>
                    <div class="col-sm-2 text-dark">
                      <a href="/stripe-payment?id_anuncio=<?php echo e($anuncio->id_anuncio); ?>" style="color:green;">Destacar</a>
                    </div>
                    <?php endif; ?>
              ...
              <div class="container">
                <div class="row">
                  ...
                  <div class="col-sm-2 text-dark">
                    ...
                    <?php if(App\Http\Controllers\FavoritosController::countFavoritos($anuncio->id_anuncio) > 0 ): ?>
                    <?php echo e(App\Http\Controllers\FavoritosController::countFavoritos($anuncio->id_anuncio)); ?> Favoritos
                    <?php else: ?>
                    <?php echo e('0 Favoritos'); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/Code/public/resources/views/Utilizadores/utilizadorDash.blade.php ENDPATH**/ ?>