...
<div class="container-fluid">
    <form class="tm-edit-product-form" action="<?php echo e(url('/dashboard/' . Auth::user()->id )); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group mb-3">
            ...
            <input id="titulo" name="titulo" type="text" maxlength="90" placeholder="Máx. 90 caracteres" value="" class="form-control validate" required="">
        </div>
